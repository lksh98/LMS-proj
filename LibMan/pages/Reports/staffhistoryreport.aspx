<%@ Page Title="Staff History Report - Lib-Man" Language="C#" MasterPageFile="/pages/Admin/Dashboard/Admin.Master" AutoEventWireup="true" CodeBehind="staffhistoryreport.aspx.cs" EnableEventValidation="false" Inherits="LibMan.pages.Reports.staffhistoryreport" %>
    ...
    <section class="mb-2">
        <div class="row  border-bottom-1">
            ...
            <div class="col-md-9 col-sm-8 col-8 mt-3">
                <h3 id="Book_head" class="heading-modal">Staff History Report </h3>
            </div>
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-2 mt-1 col-sm-9">
                <input type="text" maxlength="50" id="txt_staffID" runat="server" tabindex="1" placeholder="..............................................." class="txt_bookid BlankText   isbn all-border border-bottom-2 font-12 width-100">
            </div>
            <div class="col-md-1 mt-1 col-sm-3">
            ...
            <div class="col-md-1 mt-1 col-sm-3">
                <label class="input-label-modal">Designatioin</label>
            </div>
            <div class="col-md-2 mt-1 col-sm-9">
                <input type="text" maxlength="100" id="txt_designation" runat="server" tabindex="-1" readonly="readonly" placeholder="..............................................." class="   all-border border-bottom-2 font-12 width-100">
            </div>
            <div class="col-md-1 mt-1 col-sm-3">
                <label class="input-label-modal">Department</label>
            </div>
            <div class="col-md-2 mt-1 col-sm-9">
                <input type="text" maxlength="500" id="txt_department" runat="server" tabindex="-1" readonly="readonly" placeholder="..............................................." autocomplete="off" class="   all-border border-bottom-2 font-12 width-100">
            </div>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder_BottomScripts">
    <script>
        ...
        function DataBind(id) {
            $.ajax({
                type: "POST",
                url: 'staffhistoryreport.aspx/getIssuedBooks',
                data: "{'id':'" + id + "'}",
        ...
        $(document).on('change', '#<%=txt_staffID.ClientID%>', function () {
            ...
            var EditBook = jqPost("staffhistoryreport.aspx/getStaffDetails", "{'stid':'" + stid + "'}");
            console.log(EditBook)
            if (EditBook != null && EditBook.Table1.length > 0) {
                $('#<%=hdn_id.ClientID%>').val(EditBook.Table1[0].staff_kid);
                $('#<%=txt_name.ClientID%>').val(EditBook.Table1[0].staff_name);
                $('#<%=txt_designation.ClientID%>').val(EditBook.Table1[0].Dept_name);
                $('#<%=txt_department.ClientID%>').val(EditBook.Table1[0].designation_name);
                DataBind(EditBook.Table1[0].staff_kid);
            }
            else {
                MsgArray[0] = "Staff is not available.";
                MsgColor(true);
                MsgAlert();
                $('#<%=hdn_id.ClientID%>').val("");
