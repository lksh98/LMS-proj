...
namespace LibMan.pages.Admin.Masters
{
    public partial class course : System.Web.UI.Page
    {
        ...
        protected void btn_save_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (txt_course.Value != "")
                lst.Add(new ViewParam() { Name = "@course", Value = txt_course.Value });

            lst.Add(new ViewParam() { Name = "@usrID", Value = Common.Decrypt(Request.Cookies["LibID"].Value, true) });
            DS = DM.View.GetDataSet("[L_Course_save]", lst);
        ...
        public static string GetCourseByID(string id)
        {
            ...
            DS = DM.View.GetDataSet("L_Course_get", lst);
            return Common.ConverDatasetToJson(DS);
        }
        [WebMethod]
        public static string DeleteUpdateCourse(string id, string flag, bool status)
        {
            List<ViewParam> lst = new List<ViewParam>();
            DataSet DS = new DataSet();
            DataManager DM = new DataManager();
        ...
        public static string getAllCourses()
        {
            ...
            DataSet ds = new DataSet();
            DataManager dm = new DataManager();
            ds = dm.View.GetDataSet("L_Course_get", _lst);
            return Common.ConverDatasetToJson(ds);
        }
