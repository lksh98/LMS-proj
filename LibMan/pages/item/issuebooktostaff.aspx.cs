...
{
    public partial class issuebooktostaff : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DS = DM.View.GetDataSet("[L_issueToStaff_get]", lst);
        ...
        public static string getStaffDetails(string StaffID)
        {
            ...
            ds = dm.View.GetDataSet("L_issueToStaff_get", _lst);
        ...
        [WebMethod]
        public static string saveBook(string bookid, string StaffID)
        {
            List<ViewParam> _lst = new List<ViewParam>();
            DataSet ds = new DataSet();
            DataManager dm = new DataManager();
            ...
            ds = dm.View.GetDataSet("L_issueToStaff_save", _lst);
            return Common.ConverDatasetToJson(ds);
        }
