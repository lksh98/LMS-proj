<%@ Page Title="Issue Book to Department - Lib-Man" Language="C#" MasterPageFile="/pages/Admin/Dashboard/Admin.Master" AutoEventWireup="true" CodeBehind="issuebooktodepartment.aspx.cs" EnableEventValidation="false" Inherits="LibMan.pages.item.issuebooktodepartment" %>
    ...
    <section class="mb-2">
        <div class="row  border-bottom-1 pb-0">
            ...
            <div class="col-md-9 col-sm-8 col-8  ">
                <h3 id="Book_head" class="heading-modal">Issue Book to Department </h3>
            </div>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder_BottomScripts">
    <script>
        ...
        function DataBind() {
            $.ajax({
                type: "POST",
                url: 'issuebooktodepartment.aspx/getIssuedBooks',
        ...
        function OnSuccess(response) {
            ...
            $('#<%=hdn_current.ClientID%>').val(data.Table1.filter(e => {return e.issueToDept_status=="I"}).length);
        ...
        $(document).on('click', '.addRecord', function () {
            ...
            if (Fn_Save()) {
                if (max_book == "" || (parseInt(max_book) > parseInt(currentBook))) {
                    var EditBook = jqPost("issuebooktodepartment.aspx/saveBook", "{'bookid':'" + $('#<%=hdn_bookStock.ClientID%>').val() + "','deptID':'" + $('#<%=ddl_dept.ClientID%>').val() + "'}");
        ...
        $(document).on('change', '#<%=txt_bookID.ClientID%>', function () {
            ...
            var EditBook = jqPost("issuebooktodepartment.aspx/getBookDetails", "{'bookid':'" + bookid + "'}");
