...
{
    public partial class returnbooksfromstudent : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DS = DM.View.GetDataSet("[L_returnbooksfromstudent_get]", lst);
        ...
        public static string getStudentDetails(string StudentID)
        {
            ...
            ds = dm.View.GetDataSet("L_returnbooksfromstudent_get", _lst);
            return Common.ConverDatasetToJson(ds);
        }

        [WebMethod]
        public static string getBookDetails(string bookid, string StudentID)
        {
            List<ViewParam> _lst = new List<ViewParam>();
            DataSet ds = new DataSet();
            DataManager dm = new DataManager();
        ...
        public static string saveBook(string issueID, string remark, string fine)
        {
            ...
            ds = dm.View.GetDataSet("L_returnbooksfromstudent_save", _lst);
            return Common.ConverDatasetToJson(ds);
        }
