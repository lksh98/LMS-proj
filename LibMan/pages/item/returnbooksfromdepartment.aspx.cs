...
{
    public partial class returnbooksfromdepartment : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DS = DM.View.GetDataSet("[L_returnbooksfromdepartment_get]", lst);
                if (DS != null)
                {
        ...
        [WebMethod]
        public static string getBookDetails(string bookid, string deptID)
        {
            ...
            ds = dm.View.GetDataSet("L_returnbooksfromdepartment_get", _lst);
        ...
        public static string saveBook(string issueID, string remark, string fine)
        {
            ...
            ds = dm.View.GetDataSet("L_returnbooksfromdepartment_save", _lst);
            return Common.ConverDatasetToJson(ds);
        }
